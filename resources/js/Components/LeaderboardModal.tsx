...
export default function LeaderboardModal({ isOpen, onClose }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-start justify-center">
            ...
            {/* モーダル本体 */}
            <div className="relative w-full max-w-3xl mx-4 mt-8 mb-8 max-h-[90vh] overflow-y-auto bg-linear-to-br from-indigo-50 via-purple-50 to-pink-50 rounded-2xl shadow-2xl">
                {/* 閉じるボタン */}
                <Button
                    variant="ghost"
                    size="icon"
