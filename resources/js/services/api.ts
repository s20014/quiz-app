...
export const playerApi = {
    ...
    submitAnswer: async (
        ...
        const response = await axios.post(`/api/players/${playerId}/answer`, {
            answer,
        });
        return response.data;
    },
    ...
    updateScore: async (
        ...
        const response = await axios.patch(`/api/players/${playerId}/score`, {
            score,
        });
        return response.data;
    },
...
export const questionApi = {
    ...
    startQuestion: async (
        roomId: string,
        questionData: { type: string; correctAnswer?: string | boolean },
    ...
    gradeQuestion: async (
        ...
        const response = await axios.post(
            `/api/rooms/${roomId}/questions/grade`,
        );
        return response.data;
    },
     ...
     */
    resetQuestion: async (roomId: string): Promise<void> => {
        await axios.post(`/api/rooms/${roomId}/questions/reset`);
    },
};
